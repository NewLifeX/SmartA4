...
![Nuget Downloads](https://img.shields.io/nuget/dt/SmartA4?logo=nuget)
![Nuget](https://img.shields.io/nuget/v/SmartA4?logo=nuget)
![Nuget (with prereleases)](https://img.shields.io/nuget/vpre/SmartA4?label=dev%20nuget&logo=nuget)

IoT驱动，符合IoT标准库的PC驱动，采集CPU、内存、网络等数据，提供语音播报和重启等服务。  

源码： https://github.com/NewLifeX/SmartA4  
Nuget：SmartA4  
